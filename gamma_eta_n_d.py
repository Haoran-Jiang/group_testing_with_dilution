...
G = np.load('F_N_d.npy')
E = np.load('Eta_N_d.npy')
G_CI = np.load('F_N_d_CI.npy')
E_CI = np.load('Eta_N_d_CI.npy')

print(f'G shape is {G.shape}')
print(G[:,0])

l1 = plt.plot(range(1,101), G[:,0][0:], label = 'd=1', color='orange', linestyle='-')
l2 = plt.plot(range(2,101), G[:,1][1:], label = 'd=2', color='blue', linestyle='-')
l3 = plt.plot(range(3,101), G[:,2][2:], label = 'd=3', color='coral', linestyle='-')
l4 = plt.plot(range(4,101), G[:,3][3:], label = 'd=4', color='green', linestyle='-')
l5 = plt.plot(range(5,101), G[:,4][4:], label = 'd=5', color='gray', linestyle='-')
